-- Real historical data entry — July 2026 daily sales report, parsed
-- directly from the source Excel workbook (sheet "july"), not the flattened
-- PDF export. The workbook has four side-by-side tables on one sheet: main
...
begin
  ...
  loop
    ...
    insert into public.devices (
      ...
      rec.batch_code, rec.device_name, rec.category, null, null, 'Sold',
      v_supplier_id, rec.capital, rec.disposal, rec.condition, null,
...
begin
  for rec in
    select * from (values
      (1, '070226-006', '2026-07-02'::date, 'iPhone 16 Pro Max 256GB Gold', 'iPhones', 40000::numeric, 'Walk-in', 'Pre-owned'),
      (2, '070326-006', '2026-07-03'::date, 'iPhone 11 Pro 256GB Gold', 'iPhones', 4000::numeric, 'Walk-in', 'Pre-owned'),
      (3, '070326-007', '2026-07-03'::date, 'iPhone 13 Pro 256GB Gold', 'iPhones', 22000::numeric, 'Walk-in', 'Pre-owned'),
      (4, '070926-002', '2026-07-09'::date, 'iPhone 16 Pro Max 256GB Gold', 'iPhones', 50000::numeric, 'Walk-in', 'Pre-owned'),
      (5, '070926-003', '2026-07-09'::date, 'iPhone 16 128GB Silver', 'iPhones', 30000::numeric, 'Abraham', 'Pre-owned'),
      (6, '071026-002', '2026-07-10'::date, 'iPhone 17 Pro 256GB Silver', 'iPhones', 48000::numeric, 'Walk-in', 'Pre-owned'),
      (7, '071026-003', '2026-07-10'::date, 'iPad Air M3 128GB Grey', 'iPads', 25000::numeric, 'Walk-in', 'Pre-owned'),
      (8, '071126-005', '2026-07-11'::date, 'RS iPhone 16 128GB Silver', 'iPhones', 36000::numeric, 'Walk-in', 'Pre-owned'),
      (9, '071226-002', '2026-07-12'::date, 'iPhone 16 256GB Teal', 'iPhones', 31500::numeric, 'Walk-in', 'Pre-owned'),
      (10, '071426-003', '2026-07-14'::date, 'iPhone 13 Pro Max 128GB Gold', 'iPhones', 22500::numeric, 'Walk-in', 'Pre-owned'),
      (11, '071626-005', '2026-07-16'::date, 'iPad 10th Gen 256GB Blue', 'iPads', 13000::numeric, 'Walk-in', 'Pre-owned'),
      (12, '071626-006', '2026-07-16'::date, 'MacBook Neo 256GB Pink', 'MacBooks', 30000::numeric, 'Walk-in', 'Pre-owned'),
      (13, '072126-003', '2026-07-21'::date, 'iPhone 12 128GB White', 'iPhones', 12000::numeric, 'Walk-in', 'Pre-owned'),
      (14, '072126-004', '2026-07-21'::date, 'iPhone 17 Pro Max 256GB Blue', 'iPhones', 70500::numeric, 'Walk-in', 'Brand New'),
      (15, '072326-003', '2026-07-23'::date, 'iPhone 13 Pro 128GB Gold', 'iPhones', 22000::numeric, 'Walk-in', 'Pre-owned'),
      (16, '072326-004', '2026-07-23'::date, 'iPhone 13 Pro 256GB Silver', 'iPhones', 22000::numeric, 'Walk-in', 'Pre-owned'),
      (17, '072426-004', '2026-07-24'::date, 'iPhone 14 Pro Max 128GB Deep P', 'iPhones', 26000::numeric, 'Neil', 'Pre-owned'),
      (18, '072426-005', '2026-07-24'::date, 'iPhone 14 Pro Max 256GB Deep P', 'iPhones', 27000::numeric, 'Neil', 'Pre-owned'),
      (19, '072726-004', '2026-07-27'::date, 'iPhone 13 Pro Max 256GB Gold', 'iPhones', 23000::numeric, 'Walk-in', 'Pre-owned'),
      (20, '072726-005', '2026-07-27'::date, 'iPhone 14 128GB Black', 'iPhones', 11000::numeric, 'Walk-in', 'Pre-owned'),
      (21, '072826-003', '2026-07-28'::date, 'iPhone 16 Pro Max 1TB Gold', 'iPhones', 49000::numeric, 'Salazar', 'Pre-owned'),
      (22, '072926-002', '2026-07-29'::date, 'iPhone 15 Plus 128GB Pink', 'iPhones', 30000::numeric, 'Walk-in', 'Pre-owned'),
      (23, '072926-003', '2026-07-29'::date, 'iPhone 12 Pro Max 128GB Gold', 'iPhones', 18000::numeric, 'Paul', 'Pre-owned'),
      (24, '072926-004', '2026-07-29'::date, 'iPhone 13 Pro Max 128GB Blue', 'iPhones', 21000::numeric, 'Paul', 'Pre-owned'),
      (25, '072926-005', '2026-07-29'::date, 'iPad 10th Gen 64GB Pink', 'iPads', 12000::numeric, 'Maam Neng', 'Pre-owned'),
      (26, '073026-003', '2026-07-30'::date, 'iPad 11th Gen 128GB Silver', 'iPads', 20000::numeric, 'Walk-in', 'Pre-owned')
    ) as t(rownum, batch_code, date_added, device_name, category, price, supplier_name, condition)
    order by rownum
  loop
    v_supplier_id := null;
    if rec.supplier_name is not null then
...
-- ============================================================
-- 5 of the 26 Add-on units above were actually resold later in the same
-- month under a separate Main Sales batch code (confirmed by matching
-- model + purchase price, with the Add-on purchase date before the Main
-- sale date — not just a same-model coincidence). The resale is already
-- fully recorded as its own device/sale/sale_item under that other batch
-- code, so these don't get a second sale record (that would double-count
-- the revenue) — they're just flipped out of Available stock, since they
-- aren't actually available anymore.
