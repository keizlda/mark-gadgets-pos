...
begin
  for rec in select * from (values
    ...
    ('060526-002', 'iPhone 16 Plus', null, 'Silver', 'iPhones', 36000.0::numeric, 'Pre-owned', 'Masiba', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-05'::timestamptz),
    ...
    ('060826-006', 'iPhone 17', '256GB', 'Mist Blue', 'iPhones', 51000.0::numeric, 'Brand New', 'ND', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-08'::timestamptz),
    ('061226-002', 'iPhone 17 Pro Max', null, 'Cosmic', 'iPhones', 63000.0::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-12'::timestamptz),
    ...
    ('070926-004', 'iPhone 16', '128GB', 'Silver', 'iPhones', 30000.0::numeric, 'Pre-owned', 'Abraham', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-09'::timestamptz),
