...
begin
  for rec in select * from (values
    ...
    ('052726-002', 'iPhone 14 Pro', '128GB', 'Silver', 'iPhones', 25500.0::numeric, 'Pre-owned', 'Page', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-05-27'::timestamptz),
    ...
    ('062726-004', 'iPad 11th Gen', '128GB', 'Pink', 'iPads', 15000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-27'::timestamptz),
    ...
    ('071626-004', 'MacBook Neo', '256GB', 'Pink', 'MacBooks', 30000.0::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-16'::timestamptz),
