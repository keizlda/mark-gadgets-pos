...
begin
  for rec in select * from (values
    ...
    ('053026-001', 'iPhone 16 Pro Max', '256GB', 'Natural', 'iPhones', 46500.0::numeric, 57500.0::numeric, 'Pre-owned', null, 'Swap trade-in (from Supplier column): swap 17 pro', '2026-05-30'::timestamptz, '2026-06-08'::timestamptz),
    ('060526-001', 'iPhone 16PLUS', '128GB', 'White', 'iPhones', 36000.0::numeric, 44500.0::numeric, 'Pre-owned', null, 'Swap trade-in (from Supplier column): swap 17 pro', '2026-06-05'::timestamptz, '2026-06-08'::timestamptz),
    ...
    ('040926-001', 'iPhone 11PM', '256GB', 'Gold', 'iPhones', 13000.0::numeric, 22500.0::numeric, 'Pre-owned', null, 'Swap trade-in (from Supplier column): swap 16 plus', '2026-04-09'::timestamptz, '2026-06-22'::timestamptz),
    ...
    ('062728-001', 'iPad 11th Gen', '128GB', 'Pink', 'iPads', 15000.0::numeric, 21000.0::numeric, 'Brand New', 'Walk-in', null, '2028-06-27'::timestamptz, '2026-06-29'::timestamptz),
    ...
    ('062726-001', 'iPhone 14PM', '128GB', 'Black', 'iPhones', 30000.0::numeric, 36500.0::numeric, 'Pre-owned', 'Fr. Bagtong', null, '2026-06-27'::timestamptz, '2026-07-24'::timestamptz),
...
-- ============================================================
-- Add-on purchases (59 units) — walk-in acquisitions.
-- Most are still unsold (status Available, Selling Price 0). Units
-- confirmed resold later that same period under a separate batch
-- code go in as status Sold with a note, instead of a second sale
-- record that would double-count the revenue.
-- ============================================================
do $$
declare
  rec record;
...
begin
  for rec in select * from (values
    ('052926-002', 'iPhone 13 Pro', '128GB', 'Gold', 'iPhones', 19000::numeric, 'Pre-owned', 'Joey', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-05-29'::timestamptz),
    ('053026-002', 'iPhone 16 Pro Max', '256GB', 'Natural', 'iPhones', 46500::numeric, 'Pre-owned', 'Suki', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-05-30'::timestamptz),
    ...
    ('053126-002', 'iPhone 13 Pro Max', '128GB', 'Blue', 'iPhones', 22000::numeric, 'Pre-owned', 'Page', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-05-31'::timestamptz),
    ('053126-003', 'iPhone 17 Pro Max', '256GB', 'Silver', 'iPhones', 67000::numeric, 'Pre-owned', 'Marky', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-05-31'::timestamptz),
    ('060226-002', 'iPhone 14 Pro Max', '128GB', 'Purple', 'iPhones', 28000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-02'::timestamptz),
    ('052726-002', 'iPhone 14 Pro', '128GB', 'Silver', 'iPhones', 25500.0::numeric, 'Pre-owned', 'Page', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-05-27'::timestamptz),
    ('060526-002', 'iPhone 16 Plus', null, 'Silver', 'iPhones', 36000.0::numeric, 'Pre-owned', 'Masiba', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-06-05'::timestamptz),
    ...
    ('060826-003', 'iPhone 14 Pro Max', '128GB', 'Gold', 'iPhones', 25000::numeric, 'Pre-owned', 'Page', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-08'::timestamptz),
    ...
    ('060826-006', 'iPhone 17', '256GB', 'Mist Blue', 'iPhones', 51000.0::numeric, 'Brand New', 'ND', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-06-08'::timestamptz),
    ('061226-002', 'iPhone 17 Pro Max', null, 'Cosmic', 'iPhones', 63000.0::numeric, 'Pre-owned', 'Walk-in', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-06-12'::timestamptz),
    ('061526-003', 'iPhone 13 Pro', '256GB', 'Gold', 'iPhones', 20500::numeric, 'Pre-owned', null, 'Sold', 'Swap trade-in (from Supplier column): swap 17 pro Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-15'::timestamptz),
    ('061526-004', 'iPad Air 5 M1', '256GB', 'Blue', 'iPads', 15000::numeric, 'Pre-owned', null, 'Sold', 'Swap trade-in (from Supplier column): swap 17 pro Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-15'::timestamptz),
    ...
    ('061926-002', 'iPhone 16 Pro Max', '256GB', 'Black', 'iPhones', 38000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-19'::timestamptz),
    ...
    ('062226-043', 'iPhone 13 Pro Max', '128GB', 'Gold', 'iPhones', 22000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-22'::timestamptz),
    ...
    ('062526-003', 'iPhone 16 Pro Max', '256GB', 'Black', 'iPhones', 31000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-25'::timestamptz),
    ...
    ('062726-002', 'iPhone 14 Pro Max', '128GB', 'Purple', 'iPhones', 30000.0::numeric, 'Pre-owned', 'Bagtong', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-06-27'::timestamptz),
    ('062726-003', 'iPad 11th Gen', '128GB', 'Pink', 'iPads', 15000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-27'::timestamptz),
    ...
    ('062926-001', 'iPhone 13', '128GB', 'Pink', 'iPhones', 16500::numeric, 'Pre-owned', null, 'Sold', 'Swap trade-in (from Supplier column): swap 16 plus Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-29'::timestamptz),
    ('062926-002', 'MacBook Neo', '256GB', 'Blue', 'MacBooks', 30000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-06-29'::timestamptz),
    ...
    ('070326-004', 'iPhone 13 Pro', '256GB', 'Gold', 'iPhones', 22000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-03'::timestamptz),
    ...
    ('070926-004', 'iPhone 16', '128GB', 'Silver', 'iPhones', 30000.0::numeric, 'Pre-owned', 'Abraham', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-07-09'::timestamptz),
    ...
    ('071226-002', 'iPhone 16', '256GB', 'Teal', 'iPhones', 31500::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-12'::timestamptz),
    ('071426-002', 'iPhone 13PM', '128GB', 'Gold', 'iPhones', 22500::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-14'::timestamptz),
    ('071626-003', 'iPad 10th Gen', '256GB', 'Blue', 'iPads', 13500::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-16'::timestamptz),
    ('071626-004', 'MacBook Neo', '256GB', 'Pink', 'MacBooks', 30000.0::numeric, 'Pre-owned', 'Walk-in', 'Available', 'Walk-in purchase — no resale price set yet. Update Selling Price via Edit Device once priced.', '2026-07-16'::timestamptz),
    ...
    ('073026-002', 'iPad 11th Gen', '128GB', 'Silver', 'iPads', 20000::numeric, 'Pre-owned', 'Walk-in', 'Sold', 'Resold under a different batch code the same month — see that batch code for the actual sale record. This entry stays for the original purchase-in trail only.', '2026-07-30'::timestamptz),
